...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("camluv", ["src"], [])];
     lib_c =
       [
          ("camluv",
            "src",
            [
               ...
               "src/camluv_pipe.h";
               "src/camluv_poll.h";
               "src/camluv_prepare.h";
               "src/camluv_process.h";
               "src/camluv_request.h";
               "src/camluv_rwlock.h";
               "src/camluv_sem.h";
               "src/camluv_signal.h";
               "src/camluv_tcp.h";
     ...
     flags =
       [
          (["oasis_library_camluv_ccopt"; "compile"],
            [
          ...
          (["oasis_library_camluv_native"; "ocaml"; "link"; "native"],
            [
               (OASISExpr.EBool true, S []);
               (OASISExpr.EFlag "strict",
                 S [A "-w"; A "@a"; A "-warn-error"; A "-a"])
            ]);
          (["oasis_library_camluv_byte"; "ocaml"; "ocamldep"; "byte"],
            [
               (OASISExpr.EBool true, S []);
               (OASISExpr.EFlag "strict",
                 S [A "-w"; A "@a"; A "-warn-error"; A "-a"])
            ]);
          (["oasis_library_camluv_native"; "ocaml"; "ocamldep"; "native"],
            [
               (OASISExpr.EBool true, S []);
               (OASISExpr.EFlag "strict",
                 S [A "-w"; A "@a"; A "-warn-error"; A "-a"])
            ]);
          (["oasis_library_camluv_byte"; "ocaml"; "compile"; "byte"],
            [
               (OASISExpr.EBool true, S []);
               (OASISExpr.EFlag "strict",
                 S [A "-w"; A "@a"; A "-warn-error"; A "-a"])
            ]);
          (["oasis_library_camluv_native"; "ocaml"; "compile"; "native"],
            [
               (OASISExpr.EBool true, S []);
               (OASISExpr.EFlag "strict",
                 S [A "-w"; A "@a"; A "-warn-error"; A "-a"])
